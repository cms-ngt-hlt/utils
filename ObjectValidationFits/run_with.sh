...
python3 alter_stats.py \
 ...
 --group-file /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json --scale 1.117
python3 alter_stats.py \
 --input-file Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100.json \
 --group-file /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json --scale 1.117
python3 alter_stats.py \
...
python3 alter_stats.py \
 ...
 --group-file /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json --scale 1.117
python3 alter_stats.py \
 --input-file Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_CPU.json \
 --group-file /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json --scale 1.117
...
#  --level package --per-event --save WithNewTrackingBaseline/stacked_old.png
...
python3 compare_multiple_json_hist.py \
 ...
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/default.json \
 --labels "Legacy" $'Patatrack\n(GPU)' $'Ext. Patatrack + LST + MkFit\n(GPU)' $'Ext. Patatrack\n(GPU)' \
 --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_GPU.${TYPE}
...
python3 compare_multiple_json_hist.py \
 ...
 --labels "Legacy" $'Patatrack\n(GPU)' $'Ext. Patatrack + LST + MkFit\n(GPU)' $'Ext. Patatrack\n(GPU)' \
 --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_GPU_Trips.${TYPE}

# Compare three json with bars (CPU-based)
python3 compare_multiple_json_hist.py \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-10-25-1100_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-10-30-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_CPU_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/default.json \
 --labels "Legacy" $'Patatrack\n(CPU)' $'Ext. Patatrack + LST + MkFit\n(CPU)' $'Ext. Patatrack\n(CPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_CPU.${TYPE}
...
python3 compare_multiple_json_hist.py \
 ...
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/pixel_trips.json \
 --labels "Legacy" $'Patatrack\n(CPU)' $'Ext. Patatrack + LST + MkFit\n(CPU)' $'Ext. Patatrack\n(CPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_CPU_Trips.${TYPE}
...
python3 compare_multiple_json_hist.py \
 ...
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/default.json \
 --labels $'Patatrack\n(CPU)' $'Patatrack\n(GPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_2_CPU.${TYPE}
python3 compare_multiple_json_hist.py \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/default.json \
 --labels $'Ext. Patatrack\n(CPU)' $'Ext. Patatrack\n(GPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_3_CPU.${TYPE}
python3 compare_multiple_json_hist.py \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/default.json \
 --labels $'Ext. Patatrack + LST + MkFit\n(CPU)' $'Ext. Patatrack + LST + MkFit\n(GPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_4_Trips.${TYPE}
...
python3 compare_multiple_json_hist.py \
 ...
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/pixel_trips.json \
 --labels $'Patatrack\n(CPU)' $'Patatrack\n(GPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_2_CPU_Trips.${TYPE}
python3 compare_multiple_json_hist.py \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2025-11-10-1100_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt_pixel_trips.json \
 --colors /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/colours/pixel_trips.json \
 --labels $'Ext. Patatrack\n(CPU)' $'Ext. Patatrack\n(GPU)' --baseline 0 --label-fontsize 14 --right-text "t\\bar{t}+200~PU~|~14~TeV" --left-text "Simulation Preliminary" \
 --level package --ignore-unassigned --metric-precision 0 --save WithNewTrackingBaseline/stacked_3_CPU_Trips.${TYPE}
python3 compare_multiple_json_hist.py \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_CPU_scaled.json \
 Phase2Timing_resources_NGT_CMSSW_16_0_X_2026-02-03-1100_scaled.json \
 --group /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/circles/web/groups/hlt_pixel_trips.json \
...
cd /data/evernazz/NanoAOD/2026_01_12/CMSSW_16_0_0_pre4/src/AAA_Test/TTbar_200PU
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --xlim "0.5,250" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --xlim="-1,1" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --logy --ylim "0.0002,1" --ylim-ratio "0.,2." \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --logy --xlim "0.5,250" --ylim "0.0002,10" --ylim-ratio "0.,2." \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s "DQMData/Run 1/HLT/Run summary/Tracking/ValidationWRTtp/hltGeneral_hltAssociatorByHits/fakerate_vs_vertpos" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --logy --ylim "0.001,10" --ylim-ratio "0.,2." \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --ylim "0.003,0.1" --ylim-ratio "0.8,1.2" --logy \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
# python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s "DQMData/Run 1/HLT/Run summary/Tracking/ValidationWRTtp/hltGeneral_hltAssociatorByHits/ptres_vs_eta_Mean" \
# --legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_FullTracks_RMS/ \
# --pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --ylim="-0.05,0.05" --ylim-ratio "0.,3." \
# NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --ylim-ratio "0.5,1.5" --histogram \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s \
 "DQMData/Run 1/HLT/Run summary/JetMET/JetValidation/${JETTYPE}/chargedHadronMultiplicity_B" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --ylim-ratio "0.5,1.5" --ylim "0,0.125" --histogram --normalize \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s \
 "DQMData/Run 1/HLT/Run summary/JetMET/JetValidation/${JETTYPE}/chargedHadronMultiplicity_E" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --ylim-ratio "0.5,1.5" --ylim "0,0.1" --histogram --normalize \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s \
 "DQMData/Run 1/HLT/Run summary/JetMET/JetValidation/${JETTYPE}/chargedHadronMultiplicity_F" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --ylim-ratio "0,2" --ylim "0,0.7" --histogram --normalize \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Barrel ($ |\eta|<1.5 $)" --web --xlim "25,600" --ylim-ratio "0.95,1.05" --ylim "0,1.35" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Endcap ($ 1.5<|\eta|<3 $)" --web --xlim "25,600" --ylim-ratio "0.95,1.05" --ylim "0,1.35" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Forward ($ |\eta|>3 $)" --web --xlim "25,200" --ylim-ratio "0.95,1.05" --ylim "0,1.35" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s \
 "DQMData/Run 1/HLT/Run summary/JetMET/JetValidation/${JETTYPE}/Fake_vs_Eta" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" --revert \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --xlim="-4.,4." --ylim-ratio "0.5,1.5" --ylim "0,1.35" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" --revert \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Barrel ($ |\eta|<1.5 $)" --web --xlim "25,600" --ylim="0,1.35" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" --revert \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Endcap ($ 1.5<|\eta|<3 $)" --web --xlim "25,600" --ylim="0,1.35" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" --revert \
--rebin "40, 60, 80, 100, 150, 200" --no-logx \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Forward ($ |\eta|>3 $)" --web --xlim "25,200" --ylim="0,1.35" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root

python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s \
 "DQMData/Run 1/HLT/Run summary/JetMET/JetValidation/${JETTYPE}/ResFit_RecoOverGen_GenEta_Mean" \
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --xlim="-4.,4." --ylim "0.,4." --ylim-ratio "0.8,1.2" --histogram --no-logx \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Barrel ($ |\eta|<1.5 $)" --web --xlim "25,600" --ylim "0.,3.5" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx --histogram \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Endcap ($ 1.5<|\eta|<3 $)" --web --xlim "25,600" --ylim "0.,3.5" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Forward ($ |\eta|>3 $)" --web --xlim "25,200" --ylim "0.,3.5" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" --histogram \
--pdf --energy-text "${TITLE}" --legend-title "${JETS}" --web --xlim="-4.,4." --ylim "0.,0.7" --ylim-ratio "0.8,1.2" \
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/${OUTDIR}" \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx --histogram \
--pdf --energy-text "${TITLE}" --legend-title="${JETS} - Barrel ($ |\eta|<1.5 $)" --web --xlim "25,600" --ylim "0.,0.5" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
python3 /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/Resolution_from_DQMFile_with.py
...
# --legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_AllVertices/ \
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Vertices Performance" --xlim="2,10000" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Vertices Performance" --xlim="-19,19" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Vertices Performance" --xlim="2,10000" --ylim "0,0.4" --ylim-ratio "0.5,1.5" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Vertices Performance" --xlim="-19,19" --ylim "0,0.4" --ylim-ratio "0.,2." \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Primary Vertices Performance" --xlim="-19,19" --ylim="0,1.35" --ylim-ratio "0.8,1.2" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
python3 /data/evernazz/NanoAOD/2026_01_12/NGT_Timing/GaussianFit_from_DQMFile_with.py
...
# --legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/TTbar200PU_Validation_Vertices_1/ \
# --pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Primary Vertices Performance" --ylim-ratio "0.,2." --xlim="-10,10" --logy \
# NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting4/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
# --legend "Legacy,Patatrack,Ext. Patatrack + LST + MkFit,Ext. Patatrack" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/QCD200PU_Validation_HGCAL/ \
