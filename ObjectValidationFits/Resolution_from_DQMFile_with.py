...
def plot_response(x_min=None, x_max=None, type='Pt', bins=None, range=3, region=None, output=None):
    ...
    sigma_errs = []
    chi2_vals = []
    for i, num in enumerate([1,2,4,3]):
        mean_vals.append([])
        mean_errs.append([])
        sigma_vals.append([])
        sigma_errs.append([])
...
def plot_comparison(bins, mean_vals, mean_errs, sigma_vals, sigma_errs, xbin='Pt', type='Resolution', region=None, output=None, ymin=None, ymax=None, ymin_ratio=None, ymax_ratio=None):
    ...
    if region: 
        legend_title += f' - {region}'
    ax_main.legend(fontsize=16, ncols=4, loc='upper center', title=legend_title, title_fontsize=20)
    ax_main.grid(True, alpha=0.75, linestyle="dashdot", linewidth=0.75)
...
output_path = f'/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/QCD200PU_Validation_PFPuppiJets_Corrected/'
...
output_path = f'/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/QCD200PU_Validation_PFJets/'
...
output_path = f'/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithNewTrackingBaseline/QCD200PU_Validation_PFPuppiJets/'
