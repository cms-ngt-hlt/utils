...
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/TTbar200PU_Validation_FullTracks/ \
...
# python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s "DQMData/Run 1/HLT/Run summary/Tracking/ValidationWRTtp/hltGeneral_hltAssociatorByHits/ptres_vs_eta_Mean" \
# --legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/TTbar200PU_Validation_FullTracks_RMS/ \
# --pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT Final Tracks Performance" --ylim="-0.05,0.05" --ylim-ratio "0.,3." \
# NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o "/eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/${OUTDIR}" --histogram \
...
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/Zmumu200PU_Validation_Muons/ \
--pdf --energy-text "Zmumu 200PU (14 TeV)" --web --legend-title "Muons Performance" \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
python3 ${CMSSW_BASE}/src/DQMServices/Components/scripts/dqm-plot -s "DQMData/Run 1/HLT/Run summary/Tracking/ValidationWRTtp/hltGeneral_hltAssociatorByHits/effic" \
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/Zmumu200PU_Validation_FullTracks/ \
...
# --legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/TTbar200PU_Validation_AllVertices/ \
...
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/TTbar200PU_Validation_Vertices_1/ \
--pdf --energy-text="t\bar{t} + 200PU~(14~TeV)" --web --legend-title "HLT DA Primary Vertices Performance" --ylim-ratio "0.,2." --xlim="-10,10" --logy \
NGTScouting1/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting2/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root NGTScouting3/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root
...
--legend "Legacy,Patatrack Pixel,Extended Pixel" -o /eos/user/e/evernazz/www/NGT/Scouting/DPNotePlots/WithoutNewTrackingBaseline/QCD200PU_Validation_HGCAL/ \
...
--legend "Legacy,Extended Pixel before,Extended Pixel after" -o ./ \
--rebin "40, 60, 80, 100, 120, 140, 160, 180, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600" --no-logx --histogram \
