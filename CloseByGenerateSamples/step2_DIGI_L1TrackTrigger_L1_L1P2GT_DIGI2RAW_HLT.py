...
# with command line options: step2 -s DIGI:pdigi_valid,L1TrackTrigger,L1,L1P2GT,DIGI2RAW,HLT:@relvalRun4 --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-DIGI-RAW -n 10 --eventcontent FEVTDEBUGHLT --geometry ExtendedRun4D121 --era Phase2C22I13M9 --filein file:step1.root --fileout file:step2.root
...
assert customOpt.nParts > 0, "Use at least one particle per event."
assert customOpt.delta >= 0, "Do not use a negative distance between particles."
assert customOpt.pdgid == 11 or customOpt.pdgid == 22, "Only electrons or photons are supported."
...
infilename = "Step1_{}NEVENTS_{}NPARTS_{}PDGID_{}DELTA".format(customOpt.maxEvents, customOpt.nParts, customOpt.pdgid, deltaStr)
outfilename = "Step2_{}NEVENTS_{}NPARTS_{}PDGID_{}DELTA".format(customOpt.maxEvents, customOpt.nParts, customOpt.pdgid, deltaStr)
process.source = cms.Source("PoolSource",
    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
    fileNames = cms.untracked.vstring('file:' + infilename + '.root'),
